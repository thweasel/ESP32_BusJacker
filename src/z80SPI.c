...
const spi_bus_config_t mySPIBus_config = {
    ...
    //.flags = SPICOMMON_BUSFLAG_NATIVE_PINS,            // Abilities of bus to be checked by the driver
...
uint8_t TXbyte[4] = "";
uint8_t RXbyte[4] = "";
static spi_transaction_t fullDuplexTrans1 = {
    .cmd = 0xF0,
    //.addr = 0xE0D0,
    .tx_buffer = &TXbyte,
    .rx_buffer = &RXbyte,
...
{
    spi_device_polling_transmit(z80device_handle, &fullDuplexTrans1);
...
{
    spi_device_transmit(z80device_handle, &fullDuplexTrans1);
